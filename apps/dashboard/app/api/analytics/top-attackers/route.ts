...
// Proxy to ingest-api's GET /analytics/top-attackers (ANALYTICS_MODULE Fase
// G-backend / H3) — same pattern as app/api/analytics/credentials/top-combos/route.ts.
export async function GET(req: NextRequest) {
  ...
  const url = new URL(`${getApiUrl()}/analytics/top-attackers`)
