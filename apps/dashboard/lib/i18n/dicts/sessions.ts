...
export const en = {
  ...
  "sessions.class.persistence.label": "Persistence",
  ...
  "sessions.class.persistence.summary": "Set up a persistence mechanism (cron, SSH keys, new user, service)",
...
export const es: Record<keyof typeof en, string> = {
  ...
  "sessions.class.persistence.label": "Persistencia",
  ...
  "sessions.class.persistence.summary": "Configuró un mecanismo de persistencia (cron, claves SSH, usuario nuevo, servicio)",
