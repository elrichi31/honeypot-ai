...
export const en = {
  ...
  "reports.section.history": "12-Month History",
  "reports.history.subtitle": "Long-range context beyond the reporting period.",
  "reports.history.successRate": "Login Success Rate",
  "reports.history.topCredentials": "Most attempted credentials (12 months)",
...
export const es: Record<keyof typeof en, string> = {
  ...
  "reports.section.history": "Historial de 12 Meses",
  "reports.history.subtitle": "Contexto de largo plazo más allá del período del reporte.",
  "reports.history.successRate": "Tasa de Login Exitoso",
  "reports.history.topCredentials": "Credenciales más intentadas (12 meses)",
