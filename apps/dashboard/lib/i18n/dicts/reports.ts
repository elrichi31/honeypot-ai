...
export const en = {
  ...
  "reports.preview": "Generate report",
  "reports.download": "Download PDF",
  "reports.preview.empty": "Choose a period and generate the report.",
  "reports.progress": "Collecting report data…",
  ...
  "reports.language.label": "Report language",
  "reports.language.en": "English",
  "reports.language.es": "Spanish",
  "reports.theme.label": "Report appearance",
  "reports.theme.light": "Light",
  "reports.theme.dark": "Dark",
  "reports.insight.label": "What stands out",
  "reports.narrative.title": "Analysis",
  "reports.narrative.summary": "Executive Summary",
  "reports.narrative.landscape": "Threat Landscape",
  "reports.narrative.credentials": "Credential Attacks",
  "reports.narrative.recommendations": "Recommendations",
  "reports.narrative.pending": "Writing the analysis…",
  "reports.narrative.disclaimer": "This analysis was generated by AI from the data in this report and should be reviewed before it is acted on.",
  "reports.section.history": "Historical Context",
  "reports.history.subtitle": "Long-range activity beyond the reporting period. Covers",
  "reports.history.sshAttempts": "SSH Login Attempts",
  "reports.history.successRate": "SSH Login Success Rate",
  "reports.history.topCredentials": "Most attempted credentials over this span",
...
export const es: Record<keyof typeof en, string> = {
  ...
  "reports.preview": "Generar reporte",
  "reports.download": "Descargar PDF",
  "reports.preview.empty": "Elige un período y genera el reporte.",
  "reports.progress": "Recolectando datos del reporte…",
  ...
  "reports.language.label": "Idioma del reporte",
  "reports.language.en": "Inglés",
  "reports.language.es": "Español",
  "reports.theme.label": "Apariencia del reporte",
  "reports.theme.light": "Claro",
  "reports.theme.dark": "Oscuro",
  "reports.insight.label": "Lo que destaca",
  "reports.narrative.title": "Análisis",
  "reports.narrative.summary": "Resumen Ejecutivo",
  "reports.narrative.landscape": "Panorama de Amenazas",
  "reports.narrative.credentials": "Ataques de Credenciales",
  "reports.narrative.recommendations": "Recomendaciones",
  "reports.narrative.pending": "Redactando el análisis…",
  "reports.narrative.disclaimer": "Este análisis fue generado por IA a partir de los datos de este reporte y debe revisarse antes de actuar sobre él.",
  "reports.section.history": "Contexto Histórico",
  "reports.history.subtitle": "Actividad de largo plazo más allá del período del reporte. Cubre",
  "reports.history.sshAttempts": "Intentos de Login SSH",
  "reports.history.successRate": "Tasa de Login SSH Exitoso",
  "reports.history.topCredentials": "Credenciales más intentadas en este lapso",
