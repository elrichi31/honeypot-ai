...
export const en = {
  ...
  "sensors.config.apply.running": "Applying config and restarting the sensor…",
  "sensors.config.apply.succeeded": "Applied and confirmed — the sensor is back up with the new config.",
...
export const es: Record<keyof typeof en, string> = {
  ...
  "sensors.config.apply.running": "Aplicando configuración y reiniciando el sensor…",
  "sensors.config.apply.succeeded": "Aplicado y confirmado — el sensor volvió a levantar con la configuración nueva.",
