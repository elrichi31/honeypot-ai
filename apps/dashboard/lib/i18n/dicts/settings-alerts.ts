...
export const en = {
  ...
  "set.alerts.typeDeception": "Deception node touched",
  "set.alerts.typeDeceptionDesc": "Interaction with an internal decoy node — lateral movement",
  "set.alerts.typeCanary": "Canary token replayed",
  "set.alerts.typeCanaryDesc": "Leaked credentials or canary token used against a real endpoint",
  "set.alerts.typeFirstLogin": "First successful login",
  "set.alerts.typeFirstLoginDesc": "Attacker gained access for the first time, no commands yet",
...
export const es: Record<keyof typeof en, string> = {
  ...
  "set.alerts.typeDeception": "Nodo de deception tocado",
  "set.alerts.typeDeceptionDesc": "Interacción con un nodo señuelo interno — movimiento lateral",
  "set.alerts.typeCanary": "Canary token reutilizado",
  "set.alerts.typeCanaryDesc": "Credenciales filtradas o canary token usado contra un endpoint real",
  "set.alerts.typeFirstLogin": "Primer login exitoso",
  "set.alerts.typeFirstLoginDesc": "El atacante obtuvo acceso por primera vez, aún sin comandos",
