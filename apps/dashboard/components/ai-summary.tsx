      ...
      <div className="flex items-center justify-between border-b border-border p-4">
        <div className="flex items-center gap-2">
          ...
          <div>
            ...
            <p className="text-xs text-muted-foreground">GPT-4o mini · structured analysis</p>
          </div>
        </div>
        <button
          onClick={generate}
        ...
        >
          ...
          {loading ? "Analyzing..." : analysis ? "Regenerate" : "Analyze session"}
        </button>
      </div>
      ...
      <div className="p-4">
        ...
        {!analysis && !loading && !error && (
          <p className="text-sm text-muted-foreground">
            Click <strong>"Analyze session"</strong> to get a summary, classification,
            risk score and key indicators generated by AI.
          </p>
        )}
        ...
        {loading && (
          <div className="flex items-center gap-3 text-sm text-muted-foreground">
            ...
            Analyzing commands, credentials and behavior patterns...
          </div>
        )}
