...
# is needed. The heartbeat stays a direct POST — live state, not events. File
# uploads keep their own MD5 capture path (_save_upload) untouched; only the
# file.upload *event* flows through here.
