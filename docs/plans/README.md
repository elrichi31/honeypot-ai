...
- [THREAT_CORRELATION.md](THREAT_CORRELATION.md) - Risk scoring and threat correlation: evidence factors (canary/malware/IDS) and web volume shipped 2026-07-30; fingerprint-based actor correlation measured and dropped (it fingerprints the tool, not the operator).
